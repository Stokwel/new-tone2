...
/**
 * This is the model class for table "wheel_model_photo".
 *
 * The followings are the available columns in table 'wheel_model_photo':
 * @property integer $photo_id
 * @property integer $model_id
 * @property string $photo_name
 */
class WheelModelPhoto extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return WheelModelPhoto the static model class
	 */
