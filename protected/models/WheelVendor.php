...
/**
 * This is the model class for table "wheel_vendor".
 *
 * The followings are the available columns in table 'wheel_vendor':
 * @property integer $vendor_id
 * @property string $vendor_name
 * @property string $vendor_url
 */
class WheelVendor extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return WheelVendor the static model class
	 */
